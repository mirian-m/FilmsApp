...
final class SearchMoviePresenter: SearchMoviePresentationLogic {
    ...
    func presenMovies(response: SearchMovie.GetMovies.Response) {
        guard response.error == nil else {
            viewController?.displayAlert(viewModel: SearchMovie.GetError.ViewModel(errorModel: ErrorViewModel(title: AlerTitle.Error.error, message: response.error!.rawValue)))
            return
        }
