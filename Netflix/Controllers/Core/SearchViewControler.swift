...
//        cell.configure(with: MovieViewModel(title: movie.title ?? movie.original_title ?? "I dont kwnow", posterUrl: movie.poster_path ?? "", id: ""))
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let title = details[indexPath.row].original_title ?? details[indexPath.row].title ?? ""
